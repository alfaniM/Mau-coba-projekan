...
<body>
    ...
    <main>
        <div class="smalltron">
            <h1>PENILAIAN PKL PEMBIMBING BIDANG KEGIATAN</h1>
        </div>
        ...
        <div id="content" class="penilaian">
            <table cellpadding=5 border=1 rules=all>
                ...
                <tr>
                    <td>1</td>
                    <td style="text-align: justify;">Keahlian (Penguasaan Alat)</td>
                    <td>100</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td style="text-align: justify;">Penguasaan Materi</td>
                    <td>100</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td style="text-align: justify;">Kehadiran</td>
                    <td>100</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td style="text-align: justify;">Interaksi Sosial</td>
                    <td>100</td>
                </tr>
                <tr>
