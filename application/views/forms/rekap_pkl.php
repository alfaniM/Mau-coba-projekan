...
<body>
    ...
    <main>
        <div class="smalltron">
            <h1>REKAPITULASI PENILAIAN PRAKTEK KERJA LAPANG (PKL)</h1>
        </div>
        <div class="sub-smalltron">
            <h1>REKAPITULASI PENILAIAN PRAKTEK KERJA LAPANG (PKL)<br>
                FAKULTAS SAINS DAN TEKNOLOGI<br>
                UIN SYARIF HIDAYATULLAH JAKARTA</h1>
        </div>
        <div id="content" class="data_diri">
            <table cellpadding=5 style="text-transform: uppercase;">
                <tr>
                    <td>Prodi</td>
                    <td>:</td>
        ...
        <div id="content" class="penilaian">
            <table cellpadding=5 border=1 rules=all>
                <tr>
                    <td colspan="4" style="text-align: left;">Tabel Perolehan Nilai</td>
                </tr>
                <tr>
                    <td style="width: 15%;">Jabatan Penilai</td>
                    <td style="width: 30%;">Nama Penilai</td>
        ...
        <div id="content" class="keterangan">
            <table>
                <tr>
                    <td>Hasil Ujian Rata-Rata</td>
                    <td>:</td>
                    <td>100 (Angka)</td>
                </tr>
                <tr>
                    <td>Nilai Akhir PKL</td>
                    <td>:</td>
                    <td>A (Huruf)</td>
                </tr>
            </table>
